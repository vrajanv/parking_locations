package com.ayotta.parking.locations.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("locations");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("locations");
        ...
        config.getMapConfigs().put("com.ayotta.parking.locations.domain.*", initializeDomainMapConfig(jHipsterProperties));
